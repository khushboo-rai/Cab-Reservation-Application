...
public class Avehicledetails {
    ...
    public Avehicledetails() {
    }

    public Avehicledetails(String cab_id, String cab_Name, String cab_Number, String owner_Name, String cab_Condition) {
        this.cab_id = cab_id;
